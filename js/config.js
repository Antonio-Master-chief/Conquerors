...
const CIVS = {
  rome: {
    ...
    roster:{ sword:'legionary', horseman:'equites' }, uniques:['centurion'],
  },
  china: {
    ...
    roster:{ horseman:'keshik' }, uniques:['chukonu'], techDiscount:0.8,
  },
  india: {
    ...
    roster:{ horseman:'ashva' }, uniques:['chariot','elephant','ashva'],
  },
};
...
const UNITS = {
  ...
  crossbow: { name:'Crossbowman', hp:42, atk:10, range:4.2, speed:0.9, cd:2.5, armor:1, los:7,
              cost:{wood:40,gold:45}, pop:1, time:19, age:2, tags:['ranged'], bonusVs:{infantry:1.4} },
  longbow:  { name:'Longbowman', hp:36, atk:7,  range:6.2, speed:0.95, cd:2.0, armor:0, los:9,
              cost:{wood:35,gold:55}, pop:1, time:20, age:3, tags:['ranged'] },
  ...
  chariot:  { name:'Chariot Runner', hp:60, atk:8, range:1, speed:1.8, cd:1.3, armor:0, los:7,
              cost:{food:45,wood:50}, pop:1, time:16, age:2, tags:['cavalry'], civ:'india', big:true },
  horseman: { name:'Horseman',   hp:72,  atk:9,  range:1,   speed:1.7,  cd:1.3, armor:1, los:7,
              cost:{food:60,gold:30}, pop:1, time:18, age:2, tags:['cavalry'], big:true },
  equites:  { name:'Equites',    hp:98,  atk:13, range:1,   speed:1.7,  cd:1.3, armor:2, los:7,
              cost:{food:70,gold:60,iron:20}, pop:1, time:21, age:2, tags:['cavalry'], civ:'rome', big:true,
              bonusVs:{ranged:1.6} },
  keshik:   { name:'Keshik',     hp:56,  atk:7,  range:4.8, speed:1.65, cd:1.8, armor:0, los:9,
              cost:{wood:40,gold:65}, pop:1, time:18, age:2, tags:['cavalry','ranged'], civ:'china', big:true },
  ashva:    { name:'Ashvaroha',  hp:86,  atk:11, range:1,   speed:1.75, cd:1.3, armor:1, los:7,
              cost:{food:65,gold:45,iron:10}, pop:1, time:19, age:2, tags:['cavalry'], civ:'india', big:true },
  ...
  deer:     { name:'Deer',      hp:45,  atk:0,  range:1,   speed:1.15, cd:2,   armor:0, los:8,
              cost:{}, pop:0, time:0, age:1, tags:['animal'], civilian:true, npc:true,
              animal:true, flee:true, meat:160, big:true },
  boar:     { name:'Wild Boar', hp:120, atk:7,  range:1,   speed:1.0,  cd:1.4, armor:1, los:6,
              cost:{}, pop:0, time:0, age:1, tags:['animal'], npc:true,
              animal:true, retaliate:true, meat:360, big:true },
  wolf:     { name:'Wolf',      hp:70,  atk:9,  range:1,   speed:1.45, cd:1.4, armor:0, los:8,
              cost:{}, pop:0, time:0, age:1, tags:['animal'], npc:true,
              animal:true, retaliate:true, aggressive:true, meat:80, big:true },
  sheep:    { name:'Sheep',     hp:30,  atk:0,  range:1,   speed:0.5,  cd:2,   armor:0, los:5,
              cost:{}, pop:0, time:0, age:1, tags:['animal'], civilian:true, npc:true,
...
const BUILDINGS = {
  ...
  gate:     { name:'Gate House', hp:1100, size:1, los:3, cost:{stone:25,wood:25}, buildTime:12, age:2,
              wall:true, gateBld:true, garrison:3,
              desc:'A fortified doorway in your wall. Your own troops pass freely; enemies are barred and must batter it down. Garrison archers in the gatehouse to fire out. Build it across a wall line.' },
  barracks: { name:'Barracks', hp:850, size:2, los:5, cost:{wood:150}, buildTime:34, age:1,
              trains:['spearman','sword','legionary','centurion','elephant','catapult'],
              desc:'Trains melee infantry, beasts & siege.' },
  stable:   { name:'Stable', hp:800, size:2, los:5, cost:{wood:120,food:50}, buildTime:30, age:2,
              trains:['horseman','equites','keshik','ashva','chariot'],
              desc:'Trains cavalry. Each civilization fields its own mounted warrior — fast, hard-hitting raiders that carve through archers.' },
  range:    { name:'Archery Range', hp:750, size:2, los:5, cost:{wood:140}, buildTime:32, age:2,
              trains:['archer','crossbow','longbow','chukonu'], desc:'Trains ranged units.' },
  ...
  tower:    { name:'Watchtower', hp:520, size:1, los:9, cost:{stone:110}, buildTime:28, age:2,
              atk:9, range:6.5, cd:2.0, oilDmg:24, oilRange:1.9,
              desc:'Defensive tower. Fires arrows at range and pours boiling oil on anyone at its foot — murderous against lightly-armoured troops.' },
  keep:     { name:'Wall Tower', hp:2100, size:1, los:13, cost:{stone:220,wood:80}, buildTime:40, age:3,
              atk:18, range:13, cd:1.9, oilDmg:48, oilRange:2.4, wallTower:true, garrison:10,
              desc:'A mighty tower raised on your wall — 4× the toughness, double range, double arrow power and double oil of a watchtower. Fires only forward, over the wall. Garrison up to 10 archers: each adds +10% arrow damage and a full garrison doubles its volleys.' },
